...
/// <summary>Déclarations P/Invoke pour les hooks bas niveau, le raccourci global et la lecture de fenêtre.</summary>
internal static class NativeMethods
{
    ...
    [DllImport("gdi32.dll")]
    public static extern int GetDIBits(IntPtr hdc, IntPtr hbmp, uint start, uint cLines, byte[] lpvBits, ref BITMAPINFO lpbi, uint usage);

    // ---------------------------------------------------------------------------------------- Élévation (best effort)
    ...
    // ---------------------------------------------------------------------------------------- Session verrouillée / UAC Secure Desktop
